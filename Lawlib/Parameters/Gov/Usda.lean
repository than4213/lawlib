...
/-- The United States provides this amount per slot under the Commodity Supplemental Food Program.
    `gov/usda/csfp/amount.yaml` (policyengine-us).
    * Commodity Supplemental Food Program Fact Sheet (2019): https://fns-prod.azureedge.us/sites/default/files/resource-files/csfp-program-fact-sheet-2019.pdf
    * CSFP Final Caseload Assignments for the 2020 Caseload Cycle: https://www.fns.usda.gov/csfp/final-caseload-assignments-2020-caseload-cycle
    * CSFP Additional Caseload Assignments for the 2021 Caseload Cycle: https://www.fns.usda.gov/csfp/additional-caseload-assignments-2021-caseload-cycle
    * CSFP Caseload Assignments for the 2022 Caseload Cycle and Administrative Grants: https://www.fns.usda.gov/csfp/caseload-assignments-2022-caseload-cycle-and-administrative-grants
    * CSFP Caseload Assignments for the 2023 Caseload Cycle and Administrative Grants: https://www.fns.usda.gov/csfp/caseload-assignments-2023-caseload-cycle-and-administrative-grants
    * CSFP Caseload Assignments for the 2024 Caseload Cycle: https://www.fns.usda.gov/csfp/caseload-assignments-2024
    * CSFP Caseload Assignments for the 2025 Caseload Cycle: https://www.fns.usda.gov/csfp/caseload-assignments-2025 -/
def gov.usda.csfp.amount : DatedParam USD :=
  ⟨(⟨2019, 1, 1⟩, 330), [(⟨2020, 1, 1⟩, 333), (⟨2021, 1, 1⟩, 476), (⟨2022, 1, 1⟩, 437), (⟨2023, 1, 1⟩, 445), (⟨2024, 1, 1⟩, 531), (⟨2025, 1, 1⟩, 601)]⟩
...
/-- The US limits the Commodity Supplemental Food Program to individuals with household income below this percentage of the federal poverty guidelines.
    ...
    * COMMODITY SUPPLEMENTAL FOOD PROGRAM | 247.9 Eligibility requirements: https://www.ecfr.gov/current/title-7/part-247#p-247.9(b)
    * Commodity Supplemental Food Program (CSFP) | Revised Income Guidelines: https://fns-prod.azureedge.us/sites/default/files/resource-files/csfp-revised-incomeGuidelines2024.pdf -/
def gov.usda.csfp.fpg_limit : DatedParam Rate :=
...
/-- The Commodity Supplemental Food Program is limited to filers at or above this age.
    ...
    * COMMODITY SUPPLEMENTAL FOOD PROGRAM | 247.9 Eligibility requirements: https://www.ecfr.gov/current/title-7/part-247#p-247.9(a) -/
def gov.usda.csfp.min_age : DatedParam Rat :=
  ⟨(⟨2024, 1, 1⟩, 60), []⟩
...
/-- Program participation that qualify individuals as disabled under USDA rules
    ...
    * SNAP Special Rules for the Elderly or Disabled: https://www.fns.usda.gov/snap/eligibility/elderly-disabled-special-rules#Who%20is%20elderly? -/
def gov.usda.disabled_programs : DatedParam (List String) :=
  ⟨(⟨2021, 1, 1⟩, ["is_ssi_disabled", "social_security_disability", "is_permanently_disabled_veteran", "is_surviving_spouse_of_disabled_veteran", "is_surviving_child_of_disabled_veteran"]), []⟩

/-- USDA age threshold for elderly classification
    `gov/usda/elderly_age_threshold.yaml` (policyengine-us).
    * SNAP Special Rules for the Elderly or Disabled: https://www.fns.usda.gov/snap/eligibility/elderly-disabled-special-rules#Who%20is%20elderly? -/
def gov.usda.elderly_age_threshold : DatedParam Rat :=
  ⟨(⟨2021, 1, 1⟩, 60), []⟩

/-- `gov/usda/school_meals/amount/nslp.yaml` (policyengine-us). -/
def gov.usda.school_meals.amount.nslp.CONTIGUOUS_US.FREE : DatedParam Rat :=
  ⟨(⟨2015, 7, 1⟩, mkRat 307 100), [(⟨2016, 7, 1⟩, mkRat 79 25), (⟨2017, 7, 1⟩, mkRat 323 100), (⟨2018, 7, 1⟩, mkRat 331 100), (⟨2019, 7, 1⟩, mkRat 341 100), (⟨2020, 7, 1⟩, mkRat 351 100), (⟨2021, 7, 1⟩, mkRat 183 50), (⟨2022, 7, 1⟩, mkRat 393 100), (⟨2023, 7, 1⟩, mkRat 17 4), (⟨2024, 7, 1⟩, mkRat 443 100), (⟨2025, 1, 1⟩, mkRat 23 5)]⟩
def gov.usda.school_meals.amount.nslp.CONTIGUOUS_US.PAID : DatedParam Rat :=
  ⟨(⟨2015, 7, 1⟩, mkRat 29 100), [(⟨2016, 7, 1⟩, mkRat 3 10), (⟨2017, 7, 1⟩, mkRat 31 100), (⟨2018, 7, 1⟩, mkRat 31 100), (⟨2019, 7, 1⟩, mkRat 8 25), (⟨2020, 7, 1⟩, mkRat 33 100), (⟨2021, 7, 1⟩, mkRat 7 20), (⟨2022, 7, 1⟩, mkRat 37 100), (⟨2023, 7, 1⟩, mkRat 2 5), (⟨2024, 7, 1⟩, mkRat 21 50), (⟨2025, 1, 1⟩, mkRat 23 50)]⟩
def gov.usda.school_meals.amount.nslp.CONTIGUOUS_US.REDUCED : DatedParam Rat :=
  ⟨(⟨2015, 7, 1⟩, mkRat 267 100), [(⟨2016, 7, 1⟩, mkRat 69 25), (⟨2017, 7, 1⟩, mkRat 283 100), (⟨2018, 7, 1⟩, mkRat 291 100), (⟨2019, 7, 1⟩, mkRat 301 100), (⟨2020, 7, 1⟩, mkRat 311 100), (⟨2021, 7, 1⟩, mkRat 163 50), (⟨2022, 7, 1⟩, mkRat 353 100), (⟨2023, 7, 1⟩, mkRat 77 20), (⟨2024, 7, 1⟩, mkRat 403 100), (⟨2025, 1, 1⟩, mkRat 21 5)]⟩

/-- `gov/usda/school_meals/amount/nslp.yaml` (policyengine-us). -/
def gov.usda.school_meals.amount.nslp.AK.FREE : DatedParam Rat :=
  ⟨(⟨2015, 7, 1⟩, mkRat 499 100), [(⟨2016, 7, 1⟩, mkRat 128 25), (⟨2017, 7, 1⟩, mkRat 131 25), (⟨2018, 7, 1⟩, mkRat 269 50), (⟨2019, 7, 1⟩, mkRat 277 50), (⟨2020, 7, 1⟩, mkRat 57 10), (⟨2021, 7, 1⟩, mkRat 297 50), (⟨2022, 7, 1⟩, mkRat 637 100), (⟨2023, 7, 1⟩, mkRat 69 10), (⟨2024, 7, 1⟩, mkRat 359 50), (⟨2025, 1, 1⟩, mkRat 149 20)]⟩
def gov.usda.school_meals.amount.nslp.AK.PAID : DatedParam Rat :=
  ⟨(⟨2015, 7, 1⟩, mkRat 12 25), [(⟨2016, 7, 1⟩, mkRat 49 100), (⟨2017, 7, 1⟩, mkRat 1 2), (⟨2018, 7, 1⟩, mkRat 51 100), (⟨2019, 7, 1⟩, mkRat 53 100), (⟨2020, 7, 1⟩, mkRat 27 50), (⟨2021, 7, 1⟩, mkRat 57 100), (⟨2022, 7, 1⟩, mkRat 61 100), (⟨2023, 7, 1⟩, mkRat 33 50), (⟨2024, 7, 1⟩, mkRat 69 100), (⟨2025, 1, 1⟩, mkRat 71 100)]⟩
def gov.usda.school_meals.amount.nslp.AK.REDUCED : DatedParam Rat :=
  ⟨(⟨2015, 7, 1⟩, mkRat 459 100), [(⟨2016, 7, 1⟩, mkRat 118 25), (⟨2017, 7, 1⟩, mkRat 121 25), (⟨2018, 7, 1⟩, mkRat 249 50), (⟨2019, 7, 1⟩, mkRat 257 50), (⟨2020, 7, 1⟩, mkRat 53 10), (⟨2021, 7, 1⟩, mkRat 277 50), (⟨2022, 7, 1⟩, mkRat 597 100), (⟨2023, 7, 1⟩, mkRat 13 2), (⟨2024, 7, 1⟩, mkRat 339 50), (⟨2025, 1, 1⟩, mkRat 141 20)]⟩

/-- `gov/usda/school_meals/amount/nslp.yaml` (policyengine-us). -/
def gov.usda.school_meals.amount.nslp.HI.FREE : DatedParam Rat :=
  ⟨(⟨2015, 7, 1⟩, mkRat 18 5), [(⟨2016, 7, 1⟩, mkRat 369 100), (⟨2017, 7, 1⟩, mkRat 189 50), (⟨2018, 7, 1⟩, mkRat 97 25), (⟨2019, 7, 1⟩, 4), (⟨2020, 7, 1⟩, mkRat 411 100), (⟨2021, 7, 1⟩, mkRat 107 25), (⟨2022, 7, 1⟩, mkRat 23 5), (⟨2023, 7, 1⟩, mkRat 277 50), (⟨2024, 7, 1⟩, mkRat 144 25), (⟨2025, 1, 1⟩, mkRat 299 50)]⟩
def gov.usda.school_meals.amount.nslp.HI.PAID : DatedParam Rat :=
  ⟨(⟨2015, 7, 1⟩, mkRat 17 50), [(⟨2016, 7, 1⟩, mkRat 7 20), (⟨2017, 7, 1⟩, mkRat 9 25), (⟨2018, 7, 1⟩, mkRat 37 100), (⟨2019, 7, 1⟩, mkRat 19 50), (⟨2020, 7, 1⟩, mkRat 39 100), (⟨2021, 7, 1⟩, mkRat 41 100), (⟨2022, 7, 1⟩, mkRat 11 25), (⟨2023, 7, 1⟩, mkRat 53 100), (⟨2024, 7, 1⟩, mkRat 11 20), (⟨2025, 1, 1⟩, mkRat 57 100)]⟩
def gov.usda.school_meals.amount.nslp.HI.REDUCED : DatedParam Rat :=
  ⟨(⟨2015, 7, 1⟩, mkRat 16 5), [(⟨2016, 7, 1⟩, mkRat 329 100), (⟨2017, 7, 1⟩, mkRat 169 50), (⟨2018, 7, 1⟩, mkRat 87 25), (⟨2019, 7, 1⟩, mkRat 18 5), (⟨2020, 7, 1⟩, mkRat 371 100), (⟨2021, 7, 1⟩, mkRat 97 25), (⟨2022, 7, 1⟩, mkRat 21 5), (⟨2023, 7, 1⟩, mkRat 257 50), (⟨2024, 7, 1⟩, mkRat 134 25), (⟨2025, 1, 1⟩, mkRat 279 50)]⟩

/-- `gov/usda/school_meals/amount/sbp.yaml` (policyengine-us). -/
def gov.usda.school_meals.amount.sbp.CONTIGUOUS_US.FREE : DatedParam Rat :=
  ⟨(⟨2015, 7, 1⟩, mkRat 83 50), [(⟨2016, 7, 1⟩, mkRat 171 100), (⟨2017, 7, 1⟩, mkRat 7 4), (⟨2018, 7, 1⟩, mkRat 179 100), (⟨2019, 7, 1⟩, mkRat 46 25), (⟨2020, 7, 1⟩, mkRat 189 100), (⟨2021, 7, 1⟩, mkRat 197 100), (⟨2022, 7, 1⟩, mkRat 211 100), (⟨2023, 7, 1⟩, mkRat 57 25), (⟨2024, 7, 1⟩, mkRat 237 100), (⟨2025, 1, 1⟩, mkRat 123 50)]⟩
def gov.usda.school_meals.amount.sbp.CONTIGUOUS_US.PAID : DatedParam Rat :=
  ⟨(⟨2015, 7, 1⟩, mkRat 29 100), [(⟨2016, 7, 1⟩, mkRat 29 100), (⟨2017, 7, 1⟩, mkRat 3 10), (⟨2018, 7, 1⟩, mkRat 31 100), (⟨2019, 7, 1⟩, mkRat 31 100), (⟨2020, 7, 1⟩, mkRat 8 25), (⟨2021, 7, 1⟩, mkRat 33 100), (⟨2022, 7, 1⟩, mkRat 7 20), (⟨2023, 7, 1⟩, mkRat 19 50), (⟨2024, 7, 1⟩, mkRat 39 100), (⟨2025, 1, 1⟩, mkRat 2 5)]⟩
def gov.usda.school_meals.amount.sbp.CONTIGUOUS_US.REDUCED : DatedParam Rat :=
  ⟨(⟨2015, 7, 1⟩, mkRat 34 25), [(⟨2016, 7, 1⟩, mkRat 141 100), (⟨2017, 7, 1⟩, mkRat 29 20), (⟨2018, 7, 1⟩, mkRat 149 100), (⟨2019, 7, 1⟩, mkRat 77 50), (⟨2020, 7, 1⟩, mkRat 159 100), (⟨2021, 7, 1⟩, mkRat 167 100), (⟨2022, 7, 1⟩, mkRat 181 100), (⟨2023, 7, 1⟩, mkRat 99 50), (⟨2024, 7, 1⟩, mkRat 207 100), (⟨2025, 1, 1⟩, mkRat 54 25)]⟩

/-- `gov/usda/school_meals/amount/sbp.yaml` (policyengine-us). -/
def gov.usda.school_meals.amount.sbp.AK.FREE : DatedParam Rat :=
  ⟨(⟨2015, 7, 1⟩, mkRat 133 50), [(⟨2016, 7, 1⟩, mkRat 273 100), (⟨2017, 7, 1⟩, mkRat 279 100), (⟨2018, 7, 1⟩, mkRat 287 100), (⟨2019, 7, 1⟩, mkRat 59 20), (⟨2020, 7, 1⟩, mkRat 303 100), (⟨2021, 7, 1⟩, mkRat 63 20), (⟨2022, 7, 1⟩, mkRat 169 50), (⟨2023, 7, 1⟩, mkRat 183 50), (⟨2024, 7, 1⟩, mkRat 19 5), (⟨2025, 1, 1⟩, mkRat 79 20)]⟩
def gov.usda.school_meals.amount.sbp.AK.PAID : DatedParam Rat :=
  ⟨(⟨2015, 7, 1⟩, mkRat 43 100), [(⟨2016, 7, 1⟩, mkRat 11 25), (⟨2017, 7, 1⟩, mkRat 9 20), (⟨2018, 7, 1⟩, mkRat 23 50), (⟨2019, 7, 1⟩, mkRat 47 100), (⟨2020, 7, 1⟩, mkRat 49 100), (⟨2021, 7, 1⟩, mkRat 1 2), (⟨2022, 7, 1⟩, mkRat 27 50), (⟨2023, 7, 1⟩, mkRat 29 50), (⟨2024, 7, 1⟩, mkRat 3 5), (⟨2025, 1, 1⟩, mkRat 31 50)]⟩
def gov.usda.school_meals.amount.sbp.AK.REDUCED : DatedParam Rat :=
  ⟨(⟨2015, 7, 1⟩, mkRat 59 25), [(⟨2016, 7, 1⟩, mkRat 243 100), (⟨2017, 7, 1⟩, mkRat 249 100), (⟨2018, 7, 1⟩, mkRat 257 100), (⟨2019, 7, 1⟩, mkRat 53 20), (⟨2020, 7, 1⟩, mkRat 273 100), (⟨2021, 7, 1⟩, mkRat 57 20), (⟨2022, 7, 1⟩, mkRat 77 25), (⟨2023, 7, 1⟩, mkRat 84 25), (⟨2024, 7, 1⟩, mkRat 7 2), (⟨2025, 1, 1⟩, mkRat 73 20)]⟩

/-- `gov/usda/school_meals/amount/sbp.yaml` (policyengine-us). -/
def gov.usda.school_meals.amount.sbp.HI.FREE : DatedParam Rat :=
  ⟨(⟨2015, 7, 1⟩, mkRat 97 50), [(⟨2016, 7, 1⟩, mkRat 199 100), (⟨2017, 7, 1⟩, mkRat 203 100), (⟨2018, 7, 1⟩, mkRat 209 100), (⟨2019, 7, 1⟩, mkRat 43 20), (⟨2020, 7, 1⟩, mkRat 221 100), (⟨2021, 7, 1⟩, mkRat 229 100), (⟨2022, 7, 1⟩, mkRat 123 50), (⟨2023, 7, 1⟩, mkRat 59 20), (⟨2024, 7, 1⟩, mkRat 153 50), (⟨2025, 1, 1⟩, mkRat 159 50)]⟩
def gov.usda.school_meals.amount.sbp.HI.PAID : DatedParam Rat :=
  ⟨(⟨2015, 7, 1⟩, mkRat 33 100), [(⟨2016, 7, 1⟩, mkRat 33 100), (⟨2017, 7, 1⟩, mkRat 17 50), (⟨2018, 7, 1⟩, mkRat 7 20), (⟨2019, 7, 1⟩, mkRat 9 25), (⟨2020, 7, 1⟩, mkRat 37 100), (⟨2021, 7, 1⟩, mkRat 19 50), (⟨2022, 7, 1⟩, mkRat 2 5), (⟨2023, 7, 1⟩, mkRat 47 100), (⟨2024, 7, 1⟩, mkRat 49 100), (⟨2025, 1, 1⟩, mkRat 51 100)]⟩
def gov.usda.school_meals.amount.sbp.HI.REDUCED : DatedParam Rat :=
  ⟨(⟨2015, 7, 1⟩, mkRat 41 25), [(⟨2016, 7, 1⟩, mkRat 169 100), (⟨2017, 7, 1⟩, mkRat 173 100), (⟨2018, 7, 1⟩, mkRat 179 100), (⟨2019, 7, 1⟩, mkRat 37 20), (⟨2020, 7, 1⟩, mkRat 191 100), (⟨2021, 7, 1⟩, mkRat 199 100), (⟨2022, 7, 1⟩, mkRat 54 25), (⟨2023, 7, 1⟩, mkRat 53 20), (⟨2024, 7, 1⟩, mkRat 69 25), (⟨2025, 1, 1⟩, mkRat 72 25)]⟩
...
/-- Program participation that qualifies families for free school meals.
    ...
    * 7 CFR § 245.2 - Definitions: https://www.law.cornell.edu/cfr/text/7/245.2
    * 42 U.S. Code § 1758 - Program requirements: https://www.law.cornell.edu/uscode/text/42/1758#b_5 -/
def gov.usda.school_meals.categorical_eligibility : DatedParam (List String) :=
  ⟨(⟨2009, 9, 1⟩, ["snap", "tanf", "fdpir", "was_in_foster_care", "is_homeless", "is_runaway_child", "is_migratory_child", "is_head_start_eligible"]), []⟩

/-- `gov/usda/school_meals/income/limit.yaml` (policyengine-us). -/
def gov.usda.school_meals.income.limit.FREE : DatedParam Rate :=
  ⟨(⟨2011, 1, 1⟩, mkRat 13 10), []⟩

/-- `gov/usda/school_meals/income/limit.yaml` (policyengine-us). -/
def gov.usda.school_meals.income.limit.REDUCED : DatedParam Rate :=
...
/-- Income sources that count as income for school meal subsidies.
    ...
    * United States Code, Title 7, Subsection 273.9(b): https://www.law.cornell.edu/cfr/text/7/273.9#b -/
def gov.usda.school_meals.income.sources : DatedParam (List String) :=
  ⟨(⟨2009, 1, 1⟩, ["employment_income", "self_employment_income", "sstb_self_employment_income", "dividend_income", "interest_income", "gi_cash_assistance", "social_security", "ssi", "tanf", "pension_income", "survivor_benefits", "financial_assistance", "miscellaneous_income", "veterans_benefits", "unemployment_compensation", "strike_benefits", "rental_income", "retirement_distributions", "educational_assistance"]), []⟩

/-- School days per year
    `gov/usda/school_meals/school_days.yaml` (policyengine-us).
    * National Center for Education Statistics: Table 5.14. Number of instructional days and hours in the school year, by state: 2018: https://nces.ed.gov/programs/statereform/tab5_14.asp -/
def gov.usda.school_meals.school_days : DatedParam Rat :=
  ⟨(⟨2020, 1, 1⟩, 180), []⟩

/-- Whether a state provides free breakfast and lunch to all students participating in the National School Lunch Program and School Breakfast Program, regardless of household income.
    `gov/usda/school_meals/state_universal_free_meals.yaml` (policyengine-us).
    * FRAC | The State of Healthy School Meals for All: https://frac.org/hsmfa-report-2024 -/
def gov.usda.school_meals.state_universal_free_meals.AA : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.AE : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.AK : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.AL : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.AP : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.AR : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.AZ : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.CA : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), [(⟨2022, 7, 1⟩, true)]⟩
def gov.usda.school_meals.state_universal_free_meals.CO : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), [(⟨2023, 7, 1⟩, true)]⟩
def gov.usda.school_meals.state_universal_free_meals.CT : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.DC : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.DE : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.FL : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.GA : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.GU : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.HI : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.IA : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.ID : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.IL : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.IN : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.KS : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.KY : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.LA : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.MA : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), [(⟨2023, 7, 1⟩, true)]⟩
def gov.usda.school_meals.state_universal_free_meals.MD : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.ME : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), [(⟨2022, 7, 1⟩, true)]⟩
def gov.usda.school_meals.state_universal_free_meals.MI : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), [(⟨2023, 7, 1⟩, true)]⟩
def gov.usda.school_meals.state_universal_free_meals.MN : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), [(⟨2023, 7, 1⟩, true)]⟩
def gov.usda.school_meals.state_universal_free_meals.MO : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.MP : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.MS : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.MT : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.NC : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.ND : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.NE : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.NH : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.NJ : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.NM : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), [(⟨2023, 7, 1⟩, true)]⟩
def gov.usda.school_meals.state_universal_free_meals.NV : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.NY : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), [(⟨2025, 7, 1⟩, true)]⟩
def gov.usda.school_meals.state_universal_free_meals.OH : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.OK : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.OR : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.PA : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.PR : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.PW : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.RI : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.SC : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.SD : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.TN : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.TX : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.UT : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.VA : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.VI : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.VT : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), [(⟨2023, 7, 1⟩, true)]⟩
def gov.usda.school_meals.state_universal_free_meals.WA : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.WI : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.WV : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
def gov.usda.school_meals.state_universal_free_meals.WY : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩
...
def gov.usda.wic.abolish_wic : DatedParam Bool :=
  ⟨(⟨0, 1, 1⟩, false), []⟩

/-- Current monthly WIC cash-value benefit amount by food package.
    `gov/usda/wic/cvb/current.yaml` (policyengine-us).
    * WIC Cash-Value Voucher/Benefit Amounts for FY 2026: https://www.fns.usda.gov/wic/agency/cvvb-fy26
    * WIC Cash-Value Voucher/Benefit Amounts for FY 2024: https://www.fns.usda.gov/wic/2024-cash-value-voucher-benefit-amounts -/
def gov.usda.wic.cvb.current.BREASTFEEDING : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), [(⟨2023, 10, 1⟩, 52)]⟩
def gov.usda.wic.cvb.current.CHILD : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), [(⟨2023, 10, 1⟩, 26)]⟩
def gov.usda.wic.cvb.current.CHILD_12_23_MONTHS : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), [(⟨2023, 10, 1⟩, 26)]⟩
def gov.usda.wic.cvb.current.CHILD_24_59_MONTHS : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), [(⟨2023, 10, 1⟩, 26)]⟩
def gov.usda.wic.cvb.current.FULLY_BREASTFEEDING : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), [(⟨2023, 10, 1⟩, 52)]⟩
def gov.usda.wic.cvb.current.FULLY_BREASTFEEDING_MULTIPLES : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), [(⟨2023, 10, 1⟩, 78)]⟩
def gov.usda.wic.cvb.current.«I-BF-A» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.«I-BF-B» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.«I-BF/FF-A» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.«I-BF/FF-B» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.«I-BF/FF-C» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.«I-FF-A» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.«I-FF-B» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.«II-BF» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.«II-BF/FF» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.«II-FF» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.INFANT : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.INFANT_0_3_FULLY_FORMULA_FED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.INFANT_0_3_PARTIALLY_BREASTFED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.INFANT_0_5_FULLY_BREASTFED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.INFANT_4_5_FULLY_FORMULA_FED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.INFANT_4_5_PARTIALLY_BREASTFED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.INFANT_6_11_FULLY_BREASTFED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.INFANT_6_11_FULLY_FORMULA_FED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.INFANT_6_11_PARTIALLY_BREASTFED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.INFANT_AVERAGE : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.«IV-A» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), [(⟨2023, 10, 1⟩, 26)]⟩
def gov.usda.wic.cvb.current.«IV-B» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), [(⟨2023, 10, 1⟩, 26)]⟩
def gov.usda.wic.cvb.current.NONE : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.current.PARTIALLY_BREASTFEEDING : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), [(⟨2023, 10, 1⟩, 52)]⟩
def gov.usda.wic.cvb.current.POSTPARTUM : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), [(⟨2023, 10, 1⟩, 47), (⟨2025, 10, 1⟩, 48)]⟩
def gov.usda.wic.cvb.current.POSTPARTUM_NON_BREASTFEEDING : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), [(⟨2023, 10, 1⟩, 47), (⟨2025, 10, 1⟩, 48)]⟩
def gov.usda.wic.cvb.current.PREGNANT : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), [(⟨2023, 10, 1⟩, 47), (⟨2025, 10, 1⟩, 48)]⟩
def gov.usda.wic.cvb.current.PREGNANT_MULTIPLE_FETUSES : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), [(⟨2023, 10, 1⟩, 52)]⟩
def gov.usda.wic.cvb.current.PREGNANT_SINGLETON : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), [(⟨2023, 10, 1⟩, 47), (⟨2025, 10, 1⟩, 48)]⟩
def gov.usda.wic.cvb.current.V : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), [(⟨2023, 10, 1⟩, 47), (⟨2025, 10, 1⟩, 48)]⟩
def gov.usda.wic.cvb.current.VI : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), [(⟨2023, 10, 1⟩, 47), (⟨2025, 10, 1⟩, 48)]⟩
def gov.usda.wic.cvb.current.VII : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), [(⟨2023, 10, 1⟩, 52)]⟩

/-- WIC monthly cash-value benefit amount embedded in the 2018 average package value.
    `gov/usda/wic/cvb/included_in_value.yaml` (policyengine-us).
    * WIC Food Packages: https://www.fns.usda.gov/wic/food-packages -/
def gov.usda.wic.cvb.included_in_value.BREASTFEEDING : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 11), []⟩
def gov.usda.wic.cvb.included_in_value.CHILD : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 8), []⟩
def gov.usda.wic.cvb.included_in_value.CHILD_12_23_MONTHS : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 8), []⟩
def gov.usda.wic.cvb.included_in_value.CHILD_24_59_MONTHS : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 8), []⟩
def gov.usda.wic.cvb.included_in_value.FULLY_BREASTFEEDING : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 11), []⟩
def gov.usda.wic.cvb.included_in_value.FULLY_BREASTFEEDING_MULTIPLES : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 33 2), []⟩
def gov.usda.wic.cvb.included_in_value.«I-BF-A» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.«I-BF-B» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.«I-BF/FF-A» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.«I-BF/FF-B» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.«I-BF/FF-C» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.«I-FF-A» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.«I-FF-B» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.«II-BF» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.«II-BF/FF» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.«II-FF» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.INFANT : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.INFANT_0_3_FULLY_FORMULA_FED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.INFANT_0_3_PARTIALLY_BREASTFED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.INFANT_0_5_FULLY_BREASTFED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.INFANT_4_5_FULLY_FORMULA_FED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.INFANT_4_5_PARTIALLY_BREASTFED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.INFANT_6_11_FULLY_BREASTFED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.INFANT_6_11_FULLY_FORMULA_FED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.INFANT_6_11_PARTIALLY_BREASTFED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.INFANT_AVERAGE : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.«IV-A» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 8), []⟩
def gov.usda.wic.cvb.included_in_value.«IV-B» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 8), []⟩
def gov.usda.wic.cvb.included_in_value.NONE : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.cvb.included_in_value.PARTIALLY_BREASTFEEDING : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 11), []⟩
def gov.usda.wic.cvb.included_in_value.POSTPARTUM : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 11), []⟩
def gov.usda.wic.cvb.included_in_value.POSTPARTUM_NON_BREASTFEEDING : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 11), []⟩
def gov.usda.wic.cvb.included_in_value.PREGNANT : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 11), []⟩
def gov.usda.wic.cvb.included_in_value.PREGNANT_MULTIPLE_FETUSES : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 11), []⟩
def gov.usda.wic.cvb.included_in_value.PREGNANT_SINGLETON : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 11), []⟩
def gov.usda.wic.cvb.included_in_value.V : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 11), []⟩
def gov.usda.wic.cvb.included_in_value.VI : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 11), []⟩
def gov.usda.wic.cvb.included_in_value.VII : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 11), []⟩

/-- Whether current WIC cash-value benefits replace the cash-value benefit amount embedded in the 2018 average package values.
    `gov/usda/wic/cvb/replaces_included_value.yaml` (policyengine-us).
    * WIC Cash-Value Voucher/Benefit Amounts for FY 2024: https://www.fns.usda.gov/wic/2024-cash-value-voucher-benefit-amounts
    * WIC Cash-Value Voucher/Benefit Amounts for FY 2026: https://www.fns.usda.gov/wic/agency/cvvb-fy26 -/
def gov.usda.wic.cvb.replaces_included_value : DatedParam Bool :=
...
/-- Income sources that count as income for WIC direct income eligibility.
    ...
    * 7 CFR 246.7(d)(2)(ii)(A): https://www.law.cornell.edu/cfr/text/7/246.7#d_2_ii_A -/
def gov.usda.wic.income.sources : DatedParam (List String) :=
  ⟨(⟨2009, 1, 1⟩, ["employment_income", "self_employment_income", "military_service_income", "dividend_income", "interest_income", "gi_cash_assistance", "social_security", "ssi", "tanf", "pension_income", "survivor_benefits", "financial_assistance", "miscellaneous_income", "veterans_benefits", "unemployment_compensation", "strike_benefits", "rental_income", "retirement_distributions", "alimony_income", "child_support_received", "disability_benefits", "workers_compensation", "educational_assistance", "railroad_benefits"]), []⟩

/-- Average monthly pre-rebate value of WIC packages.
    `gov/usda/wic/value.yaml` (policyengine-us).
    * WIC Participant and Program Characteristics 2018 Food Packages and Costs Final Report: https://fns-prod.azureedge.us/sites/default/files/resource-files/WICPC2018FoodPackage-1.pdf#page=51 -/
def gov.usda.wic.value.BREASTFEEDING : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 944 25), []⟩
def gov.usda.wic.value.CHILD : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 1589 50), []⟩
def gov.usda.wic.value.CHILD_12_23_MONTHS : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 841 25), []⟩
def gov.usda.wic.value.CHILD_24_59_MONTHS : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 673 20), []⟩
def gov.usda.wic.value.FULLY_BREASTFEEDING : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 1223 25), []⟩
def gov.usda.wic.value.FULLY_BREASTFEEDING_MULTIPLES : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 3669 50), []⟩
def gov.usda.wic.value.«I-BF-A» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.value.«I-BF-B» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.value.«I-BF/FF-A» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 2047 25), []⟩
def gov.usda.wic.value.«I-BF/FF-B» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 11973 100), []⟩
def gov.usda.wic.value.«I-BF/FF-C» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 3574 25), []⟩
def gov.usda.wic.value.«I-FF-A» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 17527 100), []⟩
def gov.usda.wic.value.«I-FF-B» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 9427 50), []⟩
def gov.usda.wic.value.«II-BF» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 44), []⟩
def gov.usda.wic.value.«II-BF/FF» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 13579 100), []⟩
def gov.usda.wic.value.«II-FF» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 3929 25), []⟩
def gov.usda.wic.value.INFANT : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 3466 25), []⟩
def gov.usda.wic.value.INFANT_0_3_FULLY_FORMULA_FED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 17527 100), []⟩
def gov.usda.wic.value.INFANT_0_3_PARTIALLY_BREASTFED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 2047 25), []⟩
def gov.usda.wic.value.INFANT_0_5_FULLY_BREASTFED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.value.INFANT_4_5_FULLY_FORMULA_FED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 9427 50), []⟩
def gov.usda.wic.value.INFANT_4_5_PARTIALLY_BREASTFED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 11973 100), []⟩
def gov.usda.wic.value.INFANT_6_11_FULLY_BREASTFED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 44), []⟩
def gov.usda.wic.value.INFANT_6_11_FULLY_FORMULA_FED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 3929 25), []⟩
def gov.usda.wic.value.INFANT_6_11_PARTIALLY_BREASTFED : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 13579 100), []⟩
def gov.usda.wic.value.INFANT_AVERAGE : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 3466 25), []⟩
def gov.usda.wic.value.«IV-A» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 841 25), []⟩
def gov.usda.wic.value.«IV-B» : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 673 20), []⟩
def gov.usda.wic.value.NONE : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, 0), []⟩
def gov.usda.wic.value.PARTIALLY_BREASTFEEDING : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 978 25), []⟩
def gov.usda.wic.value.POSTPARTUM : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 768 25), []⟩
def gov.usda.wic.value.POSTPARTUM_NON_BREASTFEEDING : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 3227 100), []⟩
def gov.usda.wic.value.PREGNANT : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 3733 100), []⟩
def gov.usda.wic.value.PREGNANT_MULTIPLE_FETUSES : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 978 25), []⟩
def gov.usda.wic.value.PREGNANT_SINGLETON : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 978 25), []⟩
def gov.usda.wic.value.V : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 978 25), []⟩
def gov.usda.wic.value.VI : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 3227 100), []⟩
def gov.usda.wic.value.VII : DatedParam USD :=
  ⟨(⟨2018, 1, 1⟩, mkRat 1223 25), []⟩
