...
/-- Alaska implements the HR1 changes to Able-Bodied Adult Without Dependents work requirements
...
def states.ak.dpa.snap.work_requirements.abawd.hr1_in_effect : DatedParam Bool :=
