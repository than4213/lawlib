...
policyengine-us 1.783.0, roots ['eitc', 'ctc', 'snap'].
68 translated, 59 boundary inputs, 29 rejections.
...
- **snap_assets** (`?:0`): adds/subtracts via parameter path 'gov.usda.snap.asset_test.sources'
...
- **snap_deductions** (`?:0`): adds/subtracts via parameter path 'gov.usda.snap.income.deductions.allowed'
...
- **snap_earned_income_person** (`?:0`): adds/subtracts via parameter path 'gov.usda.snap.income.sources.earned'
